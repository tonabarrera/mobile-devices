    ...
    public void commandAction(Command co, Displayable di) {
        if (co == cs) {
            ...
            switch (ct.getSelectedIndex()) {
                case 0: a = new Alert(tt.getString(), tx.getString(), null, AlertType.ALARM);
                    break;
                case 1: a = new Alert(tt.getString(), tx.getString(), null, AlertType.CONFIRMATION);
                    break;
                case 2: a = new Alert(tt.getString(), tx.getString(), null, AlertType.ERROR);
                    break;
                case 3: a = new Alert(tt.getString(), tx.getString(), null, AlertType.INFO);
                    break;
                case 4: a = new Alert(tt.getString(), tx.getString(), null, AlertType.WARNING);
                break;
