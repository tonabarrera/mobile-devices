...
public class UnoActivity extends AppCompatActivity {
    ...
    private static final String TAG = UnoActivity.class.getName();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_uno);
        ActivityCompat.requestPermissions(UnoActivity.this,
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri u = FileProvider.getUriForFile(UnoActivity.this, BuildConfig.APPLICATION_ID + ".provider", file1);
