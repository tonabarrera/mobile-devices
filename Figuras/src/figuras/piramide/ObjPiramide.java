 ...
 * @author USER
 */
public class ObjPiramide {	// Posee los datos del objeto 3D
    ...
    public ObjPiramide(){	// CAMBIAR LAS COORDENADAS X,Y,Z CON 0,1 PARA CONSTRUIR PRISMA, CILINDRO, PIRAMIDE, CONO Y ESFERA.
        w = new Point3D[8];
        vScr = new Point2D[8];
