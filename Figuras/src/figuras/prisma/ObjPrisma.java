 ...
 */
public class ObjPrisma{	// Posee los datos del objeto 3D
    ...
    public ObjPrisma(){	// CAMBIAR LAS COORDENADAS X,Y,Z CON 0,1 PARA CONSTRUIR PRISMA, CILINDRO, PIRAMIDE, CONO Y ESFERA.
        w = new Point3D[8];
        vScr = new Point2D[8];
        ...
        w[4] = new Point3D(1, -1, 2);
        w[5] = new Point3D(1, 1, 2);
        w[6] = new Point3D(-1, 1, 2);
        w[7] = new Point3D(-1, -1, 2);
